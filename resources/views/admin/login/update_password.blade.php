                        ...
                        <div class="card rounded-0 mb-0 px-2 h-100 pb-2 justify-content-center">
                            <div class="card-header pb-1">
                                <div class="card-title">
                                    ...
                                    <h4 class="mb-0 font-large-1">Update Password</h4>
                                    <p class=" mb-0 mt-1 font-weight-light">Please enter your new password.</p>
                                </div>
                            </div>
                            <span class="text-danger">{{ $errors }}</span>
                            <div class="card-content">
                                <div class="card-body pt-0">
                                    <form action="{{ route('admin.reset.password.update', $token) }}"
                                        class="login-form" method="post">
                                        @csrf
                                        <fieldset class="mb-1 form-group position-relative has-icon-left">
                                            <label class="d-block required" for="user-password">NEW PASSWORD</label>
                                            <div class="position-relative">
                                                <input type="password" class="form-control" id="user-password"
                                                    placeholder="123qwemnb" name="password">
                                        ...
                                        <fieldset class="mb-1 form-group position-relative has-icon-left">
                                            <label class="d-block required" for="user-password">COMFIRM NEW PASSWOR</label>
                                            <div class="position-relative">
                                                <input type="password" class="form-control" id="user-password"
                                        ...
                                        <div
                                            ...
                                            <button type="submit"
                                                class="btn btn-primary w-100 btn-inline waves-effect waves-light">Save</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
